...
- **Требования**:
  - **4 проекта**: Типовой, Комфорт, Премиум, Люкс
  - **Для каждого проекта**:
    - Внешний вид дома (400x300px) - 2-3 ракурса
    - Планировки этажей (SVG или высококачественный PNG)
    - 3D-визуализации интерьера (600x400px) - 3-5 изображений
- **Временное решение**: Серые градиентные заглушки с иконками домов
